...
class UvmMsgTestCase(test.TestCase):
    ...
    def test_uvm_info_low(self):
        ...
        with mock.patch.object(self.cut, "error", autospec=True):
            ...
            iut.error.assert_called_with(
                ...
                "Usage of uvm_info is not recommended, please use cmn_info() or cmn_dbg() instead.")
    ...
    def test_uvm_info_high(self):
        ...
        with mock.patch.object(self.cut, "error", autospec=True):
            ...
            iut.error.assert_called_with(mock.ANY, mock.ANY, mock.ANY,
                                         "Usage of uvm_info is not recommended, please use cmn_dbg() instead.")
    ...
    def test_uvm_warning(self):
        ...
        with mock.patch.object(self.cut, "error", autospec=True):
            ...
            iut = self.get_listener(lb, self.cut)
            iut.error.assert_called_with(mock.ANY, mock.ANY, mock.ANY,
                                         "Usage of uvm_warning is not recommended, please use cmn_warn() instead.")
    ...
    def test_uvm_error(self):
        ...
        with mock.patch.object(self.cut, "error", autospec=True):
            ...
            iut = self.get_listener(lb, self.cut)
            iut.error.assert_called_with(mock.ANY, mock.ANY, mock.ANY,
                                         "Usage of uvm_error is not recommended, please use cmn_err() instead.")
    ...
    def test_uvm_fatal(self):
        ...
        with mock.patch.object(self.cut, "error", autospec=True):
            ...
            iut = self.get_listener(lb, self.cut)
            iut.error.assert_called_with(mock.ANY, mock.ANY, mock.ANY,
                                         "Usage of uvm_fatal is not recommended, please use cmn_fatal() instead.")
